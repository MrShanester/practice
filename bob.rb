def bob_responds(sentence)
  ...
  if sentence.split(" ").join[-1] != "?" && sentence.split(" ").join.count("a-zA-Z") == 0
    return "Whatever!"
  ...
  elsif sentence.split(" ").join[-1] == "."
    return "Sounds good."
  elsif sentence.split(" ").join[-1] == "!"
    return "Whoa, chill out!"
  elsif sentence.split(" ").join[-1] == "?"
    return "Sure."
  elsif sentence.split(" ").join.empty?
...
# Test 6
puts
puts "TEST 6: Respond to a sentence not covered by any of the other rules"
if bob_responds("this isn't covered by another rule") == "Whatever."
  puts "TEST #6 passed"
else
  puts "TEST #6 failed"
...
# Test 7
puts
puts "TEST 7: Respond to ALL CAPS"
...
# Test 8
puts
puts "TEST 8: Respond to ALL CAPS when there's also a non-letter character"
...
# Test 9
puts
puts "TEST 9: Respond to ALL CAPS when there's a question mark at the end"
...
# Test 10
puts
puts "TEST 10: Whitespace at the end should be ignored"
if bob_responds("I'm a fox.    ") == "Sounds good."
  puts "TEST #10 passed"
else
  puts "TEST #10 failed"
...
# Test 11
puts
puts "TEST 11: Respond to sentence containing no letters"
